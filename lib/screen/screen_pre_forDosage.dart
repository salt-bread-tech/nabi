...
import 'package:doctor_nyang/screen/screen_preInfo_forDosage.dart';
...
class PrescriptionDosageScreen extends StatefulWidget {
  @override
  _PrescriptionScreenState createState() => _PrescriptionScreenState();
}

class _PrescriptionScreenState extends State<PrescriptionDosageScreen> {
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PrescriptionInfoforDosage(
